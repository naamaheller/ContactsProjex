...
export const DisplayContact = ({ onClose, contact, isEdit, setIsEdit }) => {
    const languageFlags = {
        English: "GB",
        French: "FR",
        Spanish: "ES",
        ...
        <>
            ...
            <Box position="relative" textAlign="center" my={1}>
                ...
                <IconButton size="small" sx={{ position: "absolute", top: 0, right: 0, color: "#1f3b57" }}>
                    <EditIcon fontSize="small" /> <Typography variant="body2" onClick={change}>Edit</Typography>
                </IconButton>
            ...
            <Box display="flex" alignItems="center" gap={1} mb={3}>
                {contact.contactDetails?.preferredLanguage &&
                    languageFlags[contact.contactDetails.preferredLanguage] && (
                        <ReactCountryFlag
                ...
                <Typography fontSize={"0.9rem"} fontWeight="bold">
                    {contact.contactDetails?.preferredLanguage || "Not specified"}
                </Typography>
            </Box>
            <Typography variant="caption" color="textSecondary">
                Phone
